...
// highlight-range{2-3,6}
function createGreeting(name) {
  const [firstName, lastName] = name.split(" ")
  return `Hello, ${firstName}`
}

console.log(createGreeting("Guy Thomas"))
```
...
![Super wide](https://www.vets4pets.com/siteassets/species/cat/kitten/tiny-kitten-in-field.jpg?w=1280&scale=down)
